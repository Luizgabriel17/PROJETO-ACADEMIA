...
console.log("\n=== SEGUNDA-FEIRA / PERNAS COMPLETAS ===");
console.log("\n=== TERÇA-FEIRA / SUPERIOR COMPLETO ===");
console.log("\n=== QUARTA-FEIRA / BRAÇOS COMPLETOS ===");
console.log("\n=== QUINTA-FEIRA / ABDÔMEN E OMBROS ===");
...
console.log("\n=== Informações do Treino de Hoje (Braços Completos) ===");
